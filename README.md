...
1. Always add the [prettier plugin](https://github.com/tailwindlabs/prettier-plugin-tailwindcss) for automatic class sorting is Tailwindcss. This is help with debugging.
2. If you don't have an `.ico` file you can add and `icon.(ico|jpg|jpeg|png|svg)` file in the `app` folder to customize your favicon.
